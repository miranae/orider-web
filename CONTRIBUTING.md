...
Some flows need Firebase services or emulator data. See [docs/DEVELOPMENT.md](docs/DEVELOPMENT.md) for local modes and maintainer-only integration limits.
...
Branch naming and PR gates are documented in [docs/BRANCHING.md](docs/BRANCHING.md). Required checks are:
...
For new writes, API calls, logging, or feature extraction, follow [docs/CONTRIBUTOR_ARCHITECTURE.md](docs/CONTRIBUTOR_ARCHITECTURE.md).
...
Contributions use the [Developer Certificate of Origin](DCO.md), not broad copyright assignment. By contributing, you agree that your contribution is provided under [AGPL-3.0](LICENSE).
