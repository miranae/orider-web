...
export type CoachContextFilters =
  | { pmcSnapshotId: string; riderSnapshotId?: never; progressPlanner?: never }
  | { riderSnapshotId: string; pmcSnapshotId?: never; progressPlanner?: never }
  | { progressPlanner: CoachProgressPlannerContext; pmcSnapshotId?: never; riderSnapshotId?: never }
  | { pmcSnapshotId?: never; riderSnapshotId?: never; progressPlanner?: never };
