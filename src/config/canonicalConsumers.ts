 ...
 *
 * 날씨·코스·정비는 서버 배포와 백필 시점이 서로 다르다. 하나의 스위치로 묶으면 한 면의
 * 백필이 늦어질 때 나머지 둘도 못 켠다 — 그래서 **면마다 독립적으로** 켜고 끈다.
 *
...
export const CANONICAL_SURFACES = ["weather", "course", "maintenance"] as const;
...
/** 기본값. 명시적으로 true 가 들어오기 전까지 세 면 모두 꺼져 있다. */
