...
export const coachAnalytics = {
  ...
  submit: (source: QuestionSource) => track("coach_question_submit", { source, capability: "p0" }),
  ...
  actionClick: (actionCode: CoachActionCode) => track("coach_action_click", { actionCode }),
