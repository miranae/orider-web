...
export const GENERATED_DEFAULT_DIMENS = {
  "paddingXs": 4,
  "paddingS": 8,
  "paddingM": 16,
  "paddingL": 24,
  ...
  "iconM": 24,
  "iconL": 32
} as const satisfies DimenTokens;
export const GENERATED_DEFAULT_SCHEME = {
  "light": {
    "colors": {
...
} as const satisfies { light: OriderThemeVariant; dark: OriderThemeVariant };
export const FUNCTIONAL_COLORS = {
  "map": {
    "recordedTrack": "#FC5200",
    "plannedRoute": "#AB47BC"
  }
} as const;
export const COLOR_CSS_VARIABLES = {
  ...
  "textSecondary": "--ink-1",
  "textTertiary": "--ink-2",
  "textQuaternary": "--ink-3",
  "textDisabled": "--ink-4",
  "accent": "--accent",
  "accentDark": "--accent-dark",
  "accentLight": "--lime-dim",
  "accentSoftBg": "--accent-soft-bg",
  "accentSoftBorder": "--accent-soft-border",
  ...
  "error": "--color-error",
  "info": "--color-info",
  "radarSafe": "--color-radar-safe",
  "radarCaution": "--color-radar-caution",
  "radarDanger": "--color-radar-danger",
  "brandBike": "--color-brand-bike",
  "brandRun": "--color-brand-run",
  "brandSwim": "--color-brand-swim",
  "zone1": "--zone-1",
  "zone2": "--zone-2",
  "zone3": "--zone-3",
  "zone4": "--zone-4",
...
export const CHART_CSS_VARIABLES = {
  ...
  "heartRate": "--chart-heart-rate",
  "power": "--chart-power",
  "grid": "--grid-soft",
  "gridAxis": "--grid-axis",
  "gridLabel": "--chart-grid-label"
} as const;
export const DIMENSION_CSS_VARIABLES = {
  "paddingXs": "--space-1",
  "paddingS": "--space-2",
  "paddingM": "--space-4",
  "paddingL": "--space-6",
  "paddingXl": "--space-7",
  "itemGap": "--dim-item-gap",
  "itemInner": "--space-3",
  "sectionGap": "--dim-section-gap",
  "cornerRadiusS": "--r-sm",
  "cornerRadiusM": "--r-md",
  "cornerRadiusL": "--r-lg",
  "cornerRadiusXl": "--r-xl",
  "listItemHeight": "--dim-list-item-height",
  "listItemSpacing": "--dim-list-item-spacing",
  "cardPadding": "--dim-card-padding",
  "cardSpacing": "--dim-card-spacing",
  "buttonHeight": "--dim-button-height",
  "buttonPaddingHorizontal": "--dim-button-padding-horizontal",
  "dividerThickness": "--dim-divider-thickness",
  "iconS": "--dim-icon-s",
  "iconM": "--dim-icon-m",
  "iconL": "--dim-icon-l"
} as const;
