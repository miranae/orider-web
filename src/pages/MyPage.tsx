  ...
  return (
    <div>
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontSize: 17, fontWeight: 700, color: "var(--ink-0)", letterSpacing: "-0.02em" }}>
            {nickname}
          </div>
          {stravaConnected && (
            <div className="flex items-center gap-1" style={{ fontSize: 12, color: "var(--ink-4)", marginTop: 2 }}>
        ...
        <Link
          ...
          style={{
            ...
            borderRadius: "var(--r-md)", fontSize: 12, color: "var(--ink-2)", textDecoration: "none",
          }}
        >
          {t("edit")}
        </Link>
      ...
      >
        {[
          ...
          >
            <Text as="div" variant="num" style={{ fontSize: 20, color: "var(--ink-0)" }}>
      ...
      {[
        ...
        >
          ...
          <span style={{ fontSize: 14, color: "var(--ink-1)", fontWeight: 500, flex: 1 }}>{item.label}</span>
      ...
      >
        ...
        <span style={{ fontSize: 14, color: "var(--rose)", fontWeight: 500, flex: 1 }}>{t("menu.logout")}</span>
      </div>
