    ...
    const load = async () => {
      ...
      try {
        const constraints = [
          ...
          // 인덱스: 본인 프로필은 `deletedAt, userId, startTime DESC`,
          // 타인 프로필(visibility 필터 추가)은 `userId, deletedAt, visibility, startTime DESC`.
          // 둘 다 orider-g1-web `firestore/firestore.indexes.json` 에 있다(후자는 #2362 로 추가).
