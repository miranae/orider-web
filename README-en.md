...
The intended final switch is a clean repository recreation from the reviewed working tree, not a mirror push of the private history. See [Public Repository Cutover](docs/PUBLIC_REPOSITORY_CUTOVER-en.md).
