...
- Keep public issues and PRs safe for external contributors; route vulnerabilities through [SECURITY.md](../SECURITY-en.md).
...
For the cutover runbook and scan commands, see [Public Repository Cutover](PUBLIC_REPOSITORY_CUTOVER-en.md).
