...
Current public-release blockers are tracked in [PUBLIC_RELEASE_CHECKLIST.md](PUBLIC_RELEASE_CHECKLIST-en.md).

## Security Branches

Use `security/` branches only for coordinated fixes that do not expose vulnerability details in public PR text. Report vulnerabilities through [SECURITY.md](../SECURITY-en.md).
